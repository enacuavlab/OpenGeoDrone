...
//Module just for clamp drawing 
module clamp_fixation_big(wing_root_chord, wing_root, motor_arm_wdth, motor_arm_to_wg_hull)
{
    scale_up = 1;
...
//Module just for clamp drawing 
module clamp_fixation_small(wing_root_chord, wing_root, motor_arm_wdth, motor_arm_to_wg_hull)
{
    scale_up = 1;
