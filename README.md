...
The default airfoil is **MH45**, a cambered profile well-suited for slow stable RC flight. The winglet uses **NACA0008**, a symmetric thin profile. Up to three different airfoils can be blended along the span (root, mid, tip) using `slice_transitions`.
